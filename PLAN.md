...
### **ब्रोकर इंटीग्रेशन (DeepSeek AI के अनुसार)**
- **API:** Angel One SmartAPI के साथ एकीकरण ताकि उपयोगकर्ता अपने लाइव खाते को जोड़ सकें।
- **प्रमाणीकरण (Authentication):** एक प्रमाणीकरण प्रवाह (authentication flow) बनाना होगा जो OAuth 2.0 जैसा है। एक महत्वपूर्ण सीमा यह है कि एक्सेस टोकन केवल 24 घंटे के लिए वैध होता है और कोई रिफ्रेश टोकन नहीं होता है, जिसका अर्थ है कि उपयोगकर्ता को हर दिन फिर से लॉगिन करना होगा।
- **सेशन मैनेजमेंट:** उपयोगकर्ता के `access_token` और उसकी समाप्ति (expiry) को प्रबंधित करने के लिए एक मजबूत सर्वर-साइड सत्र प्रणाली की आवश्यकता होगी।
